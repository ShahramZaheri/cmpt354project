...
-- /*Create the 'users' table*/
-- CREATE TABLE users
-- ( uname varchar(255), /*Username is of type varchar (variable character field) and has a length of 255 (can hold 0 - 255 characters)*/
--     email varchar(255),
--     password varchar(255),
--     PRIMARY KEY (uname) /*Each user can be identified with their username*/
--     );
